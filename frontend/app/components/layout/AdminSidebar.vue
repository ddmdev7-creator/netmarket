...
import { PhChartBar, PhCreditCard, PhCurrencyCircleDollar, PhFlag, PhMapPin, PhMapTrifold, PhMotorcycle, PhPackage, PhSparkle, PhStorefront, PhTag, PhTruck, PhUsers } from '@phosphor-icons/vue'
