...
import { PhPackage, PhStorefront, PhUser, PhWallet } from '@phosphor-icons/vue'

const navItems = [
  { to: '/point-retrait', label: 'Colis', icon: PhPackage },
  { to: '/point-retrait/mon-point', label: 'Mon point', icon: PhStorefront },
